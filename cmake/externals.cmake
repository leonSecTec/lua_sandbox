...
if (LUA_JIT)
    ...
    externalproject_add(
        ${LUA_PROJECT}
        GIT_REPOSITORY https://github.com/leonSecTec/lua.git
        GIT_TAG 8b96f14f0be032030cdd86d56d93a6d362ca142e
...
externalproject_add(
    ...
    GIT_TAG f88d2b47027508bcf6f2d45bd0d07f79cd29c651
    CMAKE_ARGS ${SANDBOX_CMAKE_ARGS}
    INSTALL_ARGS ${INST_ARGS}
)
...
externalproject_add(
    lua_struct
    GIT_REPOSITORY https://github.com/leonSecTec/struct.git
    GIT_TAG aa719746b56f2402400edf9c42d8806ddfaf5fcc
    UPDATE_COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_LIST_DIR}/FindLua.cmake <SOURCE_DIR>/cmake
    CMAKE_ARGS ${SANDBOX_CMAKE_ARGS}
    INSTALL_ARGS ${INST_ARGS}
)
